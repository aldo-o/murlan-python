var SoundManager = {
    AddSound: function () {
        buttonClickSound = this.game.sound.add('button_click_sound');
        bgMusic = this.game.sound.add('bg_music');
        obstacleCollideSound = this.game.sound.add('obstacle_collide_sound');
        knifeAttachSound = this.game.sound.add('knife_attach_sound');
    },
